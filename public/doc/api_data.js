define({ "api": [
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -X POST -H \"Content-type: application/json\" -H \"appkey: abc\" -d '{ \"playerId\": \"c1e1ee53-ae51-423c-b07d-9a98f74f1cfa\", \"timezone\": -8, \"params\": { \"campaignLength\": \"30\", \"difficultyLevel\": \"hard\", \"randomEvents\": \"low\" } }' https://walkertrekker.herokuapp.com/api/campaigns",
        "type": "curl"
      }
    ],
    "success": {
